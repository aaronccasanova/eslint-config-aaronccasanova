...
- You can see all the [rules here](https://github.com/aaronccasanova/eslint-config-aaronccasanova/blob/master/.eslintrc.js) - these generally abide by the code written in my courses. You are very welcome to overwrite any of these settings, or just fork the entire thing to create your own.
